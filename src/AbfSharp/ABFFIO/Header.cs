...
namespace AbfSharp.ABFFIO
{
    ...
    public unsafe struct Header
    {
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Constants.ABF_ADCCOUNT)] public string nLowpassFilterType;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Constants.ABF_ADCCOUNT)] public string nHighpassFilterType;
        [MarshalAs(UnmanagedType.ByValArray, SizeConst = Constants.ABF_ADCCOUNT)] public Byte[] bHumFilterEnable;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Constants.ABF_ADCCOUNT * Constants.ABF_ADCNAMELEN)] public string sADCChannelName;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Constants.ABF_ADCCOUNT * Constants.ABF_ADCUNITLEN)] public string sADCUnits;
        ...
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Constants.ABF_DACCOUNT * Constants.ABF_DACNAMELEN)] public string sDACChannelName;
        [MarshalAs(UnmanagedType.ByValTStr, SizeConst = Constants.ABF_DACCOUNT * Constants.ABF_DACUNITLEN)] public string sDACChannelUnits;
